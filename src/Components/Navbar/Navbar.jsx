  ...
  return (
    <>
        <nav className='navbar'>
            ...
            <Link activeClass='active' to='contact' spy={true} smooth={true} offset={-100} duration={500}><button className='navbtn'><img src='src/assets/message.png' className='btnimg'/>Contact me</button></Link>
